...
interface ContactDropdownProps {
  ...
  /** Passed from MenuCard to apply per-card button shape overrides */
  buttonRadius?: string;
...
export function ContactDropdown({
  ...
  const whatsappNumber = socialLinks?.whatsapp || SELLER_CONFIG.whatsapp;
  const instagramHandle = socialLinks?.instagram || SELLER_CONFIG.instagram;
  const emailAddress = socialLinks?.email || SELLER_CONFIG.email;
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      {isOpen && (
        <div className="absolute bottom-full right-0 mb-2 w-56 bg-background/98 backdrop-blur-xl rounded-xl shadow-2xl border border-border overflow-hidden z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
          <div className="p-2 space-y-1">
            ...
            >
              <div className="w-8 h-8 rounded-full bg-green-600 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform text-white">
            ...
            <a
              ...
              className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-secondary transition-colors group"
            >
              <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-amber-500 via-rose-500 to-fuchsia-600 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform text-white">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="font-medium text-sm text-foreground">Instagram</div>
            </a>
            ...
            <a
              ...
              className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-secondary transition-colors group"
            >
              <div className="w-8 h-8 rounded-full bg-[hsl(220,15%,30%)] flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform text-white">
