...
export function Hero() {
  ...
  useGSAP(() => {
    ...
    // Updated: Image will slide in from the right fully visible (no fade)
    gsap.from(".hero-img", {
      x: 100,
      duration: 1,
      ease: "power3.out",
  ...
  return (
    <section className="pt-20 min-h-screen bg-white relative overflow-hidden flex flex-col md:flex-row items-center border-b-4 border-black">
      ...
      <div className="w-full md:w-1/2 h-[50vh] md:h-screen relative bg-[#f0f0f0] md:border-l-4 border-black border-t-4 md:border-t-0 flex items-center justify-center overflow-hidden">
        ...
        <img
          src="https://images.unsplash.com/photo-1656944227421-416b1d2186c9?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YWlyJTIwam9yZGFufGVufDB8fDB8fHww"
