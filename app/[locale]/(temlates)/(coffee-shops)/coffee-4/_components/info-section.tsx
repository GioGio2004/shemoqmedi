          ...
          <div className="relative p-8 md:p-10 rounded-2xl bg-primary text-primary-foreground flex flex-col justify-between min-h-[380px] overflow-hidden group">
            <div className="relative z-10">
              ...
              <div className="mt-6">
                ...
                <p className="text-lg text-primary-foreground/70">Portland, OR 97201</p>
              </div>
            </div>
            ...
            <div className="relative z-10">
              <button
                type="button"
                className="flex items-center gap-2 px-6 py-3 bg-primary-foreground text-primary rounded-full font-medium hover:opacity-90 transition-all"
              >
                Get Directions
