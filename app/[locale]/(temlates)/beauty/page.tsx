    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="hover:bg-rose-100 text-slate-800 transition-colors rounded-full"
          disabled={isPending}
        >
      ...
      <DropdownMenuContent
        align="end"
        className="bg-[#fffdf9] border-rose-100 z-[60]"
      >
        <DropdownMenuItem
...
export default function Home() {
  const t = useTranslations("BeautyTemplate");
    ...
    >
      ...
      <section className="benefits-section relative z-10 py-32 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-black mb-4">{t("Benefits.title")}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {benefitItems.map((item, idx) => (
            <div
              key={idx}
              className="benefit-item text-center p-8 rounded-3xl bg-white/50 backdrop-blur-sm border border-white/60 shadow-lg hover:shadow-xl transition-shadow"
            >
              <div
        ...
        <div className="h-screen flex items-center m-20">
          ...
          <div className="fixed top-20 padding-10 left-10 md:left-20 z-50 pointer-events-none">
            <h2 className="text-4xl md:text-6xl font-black text-white drop-shadow-2xl">
              ...
              <span className="text-rose-500">{t("Ingredients.title_2")}</span>
            </h2>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonialItems.map((item, idx) => (
            <div
              key={idx}
              className="testimonial-card bg-white rounded-3xl p-8 shadow-xl border border-slate-100"
            >
