...
import { PRODUCTS } from "@/app/[locale]/(temlates)/beauty/_components/image-listing";
    ...
    <>
      ...
      {!isOpen && !isProcessing && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 p-4 md:p-5 bg-gradient-to-br from-red-600 to-red-200 text-white rounded-full shadow-2xl shadow-orange-900/50 hover:scale-110 transition-all duration-300 group backdrop-blur-xl"
        >
          <SquircleIcon className="w-6 h-6 md:w-7 md:h-7 group-hover:rotate-12 transition-transform" />
            ...
            {messages.length === 0 ? (
              <div className="h-full flex items-center justify-center text-center">
                <div className="voloo-ui-element space-y-8 px-4 max-w-lg mx-auto">
                  <div className="w-20 h-20 md:w-24 md:h-24 mx-auto bg-gradient-to-br from-red-600/20 to-red-200/10 rounded-3xl flex items-center justify-center backdrop-blur-xl border border-white/5">
                    <SquircleIcon className="w-10 h-10 md:w-12 md:h-12 text-red-600" />
                  </div>
                  <div>
                  ...
                  <div className="flex flex-wrap gap-3 justify-center">
                    ...
                    {/* here we add some suggestions and modify it accordibly */}
                    {["Suggest a product", "Best seller?", "New arrivals"].map((suggestion, idx) => (
                      <button
                        key={idx}
          ...
          >
            <div className="max-w-5xl mx-auto flex gap-3 md:gap-4">
              ...
              <button
                ...
                className="px-8 py-4 bg-gradient-to-br from-red-600 to-red-200 text-white rounded-xl md:rounded-2xl font-black hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-lg shadow-blue-900/30 uppercase tracking-wider"
              >
